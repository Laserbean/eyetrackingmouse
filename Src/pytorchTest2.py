...
class ConvNet(torch.nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(36 * 36 * f2, 200) #fully connected layer
...
trainingSet = dataLoad("mydata")
test = dataLoad("mytest")
...
def trainModel():
    ...
    model.train() #sets to training mode / opposite of model.eval()
